...
# Ids are assigned in list order, so traps append after the existing names and
# earlier ids stay stable.
ITEM_NAME_TO_ID: dict[str, int] = {}
_next = ITEM_ID_BASE
for _name in LEVEL_ACCESS_ITEMS + FILLER_NAMES + TRAP_NAMES:
